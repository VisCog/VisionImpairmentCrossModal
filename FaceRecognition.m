...
[y440,Fs] = audioread([homedir filesep 'beep_sounds\440Hz_50ms.wav']); % new trial sound
[y220,Fs] = audioread([homedir filesep 'beep_sounds\220Hz_300ms.wav']); % wrong keypress
